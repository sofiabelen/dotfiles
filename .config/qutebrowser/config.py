...
# Cycle around your stylesheets collection:
config.bind('xs', 'config-cycle content.user_stylesheets "~/.config/qutebrowser/nord-dark-all-sites.css" ""')

config.bind('xi', 'config-cycle colors.webpage.darkmode.enabled true false ;; restart')
